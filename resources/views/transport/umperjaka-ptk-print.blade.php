<style type="text/css">
    ...
    <table width="100%" border="1">
      ...
      <tr>
        ...
        <td width="83%"><div align="center" class="style1">PERTANGGUNG JAWABAN UANG MUKA <p>KANTOR PERWAKILAN JAKARTA</p>No : {{$ptk->no_ptk}}</p></div></td>
      </tr>
    </table>
    <table width="100%">
      <tr>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><span class="style2">{{$ptk->getRkapDetail->getRkap->cost_center}} - {{$ptk->getRkapDetail->getRkap->gl_acc}}</span></td>
      </tr>
      <tr>
    ...
    <table width="100%" rules="all">
      <tr>
        <td colspan="6">&nbsp;<span class="style4">Uraian : {{$ptk->uraian}}</span></td>
        </tr>
      <tr>
      ...
      @foreach($ptk->getRealisasiUmDet as $index => $data)
      <tr>
        <td>{{$no++}}</td>
        <td>{{ $data->jumlah }}</td>
        <td>&nbsp;</td>
