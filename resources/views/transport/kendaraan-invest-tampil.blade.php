...
@section('title','Data Kendaraan Investasi')
@section('content')
<div class="container-fluid mt-3">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Data Kendaraan Investasi</h4>
                    <form action="/transport/cari1" method="get">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <a href="/transport/kendaraan-invest-create" class="btn btn-success">Kend. Invest</a>
                            </div> 
                    </form>
