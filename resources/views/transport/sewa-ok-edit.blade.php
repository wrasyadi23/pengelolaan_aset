                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-content">
                            <form action="/transport/sewa-ok-update/{{ $editok->id}}" method="post">
                                @csrf
                                <div class="basic-form">
                                    ...
                                    <div class="general-button">
                                        <button type="button" class="btn btn-primary" onclick="window.location.href='/transport/sewa-ok-tampil'">Back</button>
