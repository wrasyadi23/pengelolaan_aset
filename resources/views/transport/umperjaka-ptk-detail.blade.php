    ...
    <div class="container-fluid mt-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Realisasi Detail</h4>
                        <div class="card-content">
                            <form action="/transport/umperjaka-ptk-detail-store" method="post">
                                @csrf
                                <div class="basic-form">
                                    <div class="form-row">
                                        <div class="form-group col-md-12 style1">
                                            <label for="kd_ptk">Kode Ptk</label>
                                            <input type="text" name="kd_ptk" id="" class="form-control input-default"value="{{ $getptk->first()->kd_ptk}}">
                                        </div>   
                                    </div>
                                    <div class="form-row">
