                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-content">
                            <form action="/transport/sewa-pr-update/{{ $editpr->id}}" method="post">
                                @csrf
                                <div class="basic-form">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12 style1">
                                            ...
                                            <input type="date" name="tgl" id="" class="form-control input-default" placeholder="Tanggal Sr" required  value="{{ $editpr->tgl }}">
                                        </div>
                                    </div>
                                    
                                    <div class="general-button">
                                        <button type="button" class="btn btn-primary" onclick="window.location.href='/transport/sewa-pr-tampil'">Back</button>
