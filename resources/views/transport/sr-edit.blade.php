                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-content">
                            <form action="/transport/sr-update/{{ $editsr->id }}" method="post">
                                @csrf
                                <div class="basic-form">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12 style1">
                                            ...
                                            <input type="date" name="tgl_awal" id="" class="form-control input-default" placeholder="Tanggal Awal Sr" required value="{{ $editsr->tgl_awal }}">
                                        </div>
                                        <div class="form-group col-md-12 style1">
                                            <label for="type">Tangal Akhir</label>
                                            <input type="date" name="tgl_akhir" id="" class="form-control input-default" placeholder="Tangal Akhir Sr " required value="{{ $editsr->tgl_akhir }}">
                                        </div>
                                        <div class="form-group col-md-12 style1">
