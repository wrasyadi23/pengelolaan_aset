                        ...
                        <div class="card-content">
                            ...
                            <div class="general-button">
                                <button class="btn btn-primary" type="button"
                                        onclick="window.location.href='/pemeliharaan/pekerjaan'">Back
                                </button>
                                @if ($pekerjaan->status == 'Requested' || $pekerjaan->status == 'Revisi')
                                    <button class="btn btn-primary" type="button"
                                            onclick="window.location.href='/pemeliharaan/pekerjaan-edit/{{$pekerjaan->booknumber}}'">
                                        Edit
                                    </button>
                                    @if (Auth::user()->role == 'Admin')
                                        <button class="btn btn-success" type="button" data-toggle="modal"
                                                data-target="#modalRevisi">Revisi
                                        </button>
                                        <button class="btn btn-success" type="button" data-toggle="modal"
                                                data-target="#modalApprove">Approve
                                        </button>
                                    @endif
                                @endif
                                @if ($pekerjaan->status == 'Approved')
                                    @if (Auth::user()->role == 'Worker')
                                        <button class="btn btn-primary"
                                                onclick="window.location.href='/pemeliharaan/pekerjaan-proceed/{{$pekerjaan->booknumber}}'">
                                            Proceed
                                        </button>
                                    @elseif(Auth::user()->role == 'Admin')
                                        <button class="btn btn-warning" type="button" data-toggle="modal"
                                                data-target="#modalDisapprove">Disapprove
                                        </button>
                                    @endif
                                @endif
                                @if ($pekerjaan->status == 'In Progress' && Auth::user()->role == 'Worker')
                                    <button class="btn btn-primary"
                                            onclick="window.location.href='/pemeliharaan/pekerjaan-done/{{$pekerjaan->booknumber}}'">
                                        Done
                                    </button>
                                @endif
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form
                                                    action="/pemeliharaan/pekerjaan-approve/{{$pekerjaan->booknumber}}"
                                ...
                                <div class="modal fade" id="modalDisapprove" style="display: none;" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form
                                                    action="/pemeliharaan/pekerjaan-disapprove/{{$pekerjaan->booknumber}}"
                                            ...
                                            <div class="modal-body">
                                                <form action="/pemeliharaan/pekerjaan-close/{{$pekerjaan->booknumber}}"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="closed" class="btn btn-primary">
                                                            Submit
                                                        </button>
                                                    </div>
                                                </form>
                                            ...
                                            <div class="modal-body">
                                                <form action="/pemeliharaan/pekerjaan-revisi/{{$pekerjaan->booknumber}}"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="revisi" class="btn btn-primary">
                                                            Submit
                                                        </button>
                                                    </div>
                                                </form>
                            ...
                            {{-- modalEnd  --}}
                            <div class="bootstrap-modal">
                                <div class="modal fade" id="modalEnd" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                                ...
                                                <br>
                                                <h4 class="text-center">{{session('close')}}</h4>
                                            </div>
                                            <div class="modal-footer">
                                                <button class="btn btn-secondary" data-dismiss="modal"
                                                        onclick="window.location.href='/pemeliharaan/pekerjaan'">Close
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @if ($waitinglist->count() != null)
                                        @foreach ($waitinglist as $key => $list)
                                            <tr>
                                                ...
                                                <td>{{$list->kd_klasifikasi_pekerjaan}}
                                                    - {{$list->getKlasifikasi->klasifikasi_pekerjaan}}</td>
...
@push('css-stack')
    <link rel="stylesheet" href="{{asset('plugins/star-rating/css/star-rating.css')}}">
