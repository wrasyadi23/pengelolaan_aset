                            ...
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_sp" id="jenis_sp" class="form-control input-default" required>
                                        <option value="Tetap" {{old('jenis_sp', $kontrak->jenis_sp) == 'Tetap' ? 'selected' : ''}}>Sewa Tetap</option>
                                        <option value="Isidentil" {{old('jenis_sp', $kontrak->jenis_sp) == 'Isidentil' ? 'selected' : ''}}>Sewa Isidentil</option>
                                        <option value="TA/Crash Program" {{old('jenis_sp', $kontrak->jenis_sp) == 'TA/Crash Program' ? 'selected' : ''}}>Sewa TA/Crash Program</option>
                                    </select>
                                </div>
                                <div class="form-group">
